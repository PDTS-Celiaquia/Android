            ...
            public void onClick(View view) {
                ...
                switch (reg.getCodigo()){
                    case(200):
                        ...
                        break;
                    case(401):
                        toast = Toast.makeText(getApplicationContext(), "Error pendiente", Toast.LENGTH_SHORT);
                        break;
                    default:
                        toast = Toast.makeText(getApplicationContext(), "Error inesperado "+reg.getCodigo(), Toast.LENGTH_SHORT);
                }
                toast.show();
            }
        });
